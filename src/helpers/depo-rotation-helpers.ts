...
const BAYUR_BLOCK_ROTATIONS: Record<string, number> = {
	...
	N: Math.PI / 4, // 315 degrees
	O: Math.PI / 4,     // 22.5 degrees
	P: Math.PI / 2, // 67.5 degrees
	Q: Math.PI / 2, // 112.5 degrees
	R: 15 * Math.PI / 4, // 157.5 degrees
	S: 15 * Math.PI / 4, // 202.5 degrees
	T: 15 * Math.PI / 4, // 247.5 degrees
	U: Math.PI / 3.5, // 292.5 degrees
	V: 15 * Math.PI / 8, // 337.5 degrees
	W: Math.PI / 12, // 15 degrees
	X: Math.PI / 3.5, // 36 degrees
};
